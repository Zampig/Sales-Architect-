...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, settings, onSettingsChange, onReset, onOpenProfile, onSignOut }) => {
  const personas = [
        ...
        {settings.mode !== 'coaching' && (
            ...
            <div className="grid grid-cols-3 bg-gemini-card p-1 rounded-lg border border-gemini-highlight">
                ...
                <button
                    ...
                    className={`text-xs font-medium py-2 px-3 rounded-md capitalize transition-all ${
