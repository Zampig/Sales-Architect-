      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Strategy Chat</h3>
          ...
          <button 
            ...
            className="group relative flex flex-col items-start p-8 bg-gemini-card border border-gemini-highlight rounded-2xl hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10 transition-all text-left h-full"
          >
            <div className="p-4 bg-cyan-500/10 rounded-xl mb-6 group-hover:bg-cyan-500 group-hover:text-white transition-colors text-cyan-400">
              <User size={28} />
            </div>
            <h3 className="text-xl font-semibold text-white mb-2">Live Roleplay</h3>
            <p className="text-sm text-gemini-muted leading-relaxed mb-8 flex-1">
              Voice simulation with a tough prospect. Practice your pitch in real-time.
            </p>
            <div className="flex items-center text-cyan-400 text-sm font-medium group-hover:gap-2 transition-all">
              Start Simulation <ArrowRight size={16} className="opacity-0 group-hover:opacity-100 ml-1 transition-opacity" />
            </div>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gemini-muted leading-relaxed mb-8 flex-1">
              Casual voice consultation with your mentor. Brainstorm and debrief.
            </p>
